...
class INET_API Ieee80211YansErrorModel : public Ieee80211ErrorModelBase
{
  protected:
    ...
    // Added on 13/9/22 to get BER information
    double calcBERfromModulation(const ApskModulationBase *subcarrierModulation, Hz signalSpread, bps phyRate, double snr) const;
    virtual double getDataBitErrorRate(const IIeee80211Mode *mode, double snr) const override;
