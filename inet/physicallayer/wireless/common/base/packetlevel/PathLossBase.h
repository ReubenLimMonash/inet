...
class INET_API PathLossBase : public cModule, public IPathLoss
{
  public:
    ...
    virtual double computeCompositePathLoss(mps propagationSpeed, Hz frequency, m distance, const ITransmission *transmission, const IArrival *arrival) const override = 0;
