...
class INET_API IReceiver : public IPrintableObject
{
  public:
     ...
     * parallel computation.
     */
    virtual const IReceptionResult *computeReceptionResult(const IListening *listening, const IReception *reception, const IInterference *interference, const ISnir *snir, const std::vector<const IReceptionDecision *> *decisions, const double distance) const = 0;
};
