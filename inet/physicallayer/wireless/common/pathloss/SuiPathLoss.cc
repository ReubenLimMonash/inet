...
double SuiPathLoss::computeCompositePathLoss(mps propagationSpeed, Hz frequency, m distance, const ITransmission *transmission, const IArrival *arrival) const
{
    m R = distance;
    m R0 = m(100.0);
    m lambda = propagationSpeed / frequency;
