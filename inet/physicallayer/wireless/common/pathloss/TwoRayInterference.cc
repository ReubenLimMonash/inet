...
double TwoRayInterference::computeCompositePathLoss(mps propagationSpeed, Hz frequency, m distance, const ITransmission *transmission, const IArrival *arrival) const
{
    return NaN;
}
