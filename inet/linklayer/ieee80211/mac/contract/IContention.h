...
class INET_API IContention
{
  ...
  public:
    ...
    // On 29/8/22, changed the below function to return backoffPeriod generated
    // virtual void startContention(int cw, simtime_t ifs, simtime_t eifs, simtime_t slotTime, ICallback *callback) = 0;
    virtual int startContention(int cw, simtime_t ifs, simtime_t eifs, simtime_t slotTime, ICallback *callback) = 0;
