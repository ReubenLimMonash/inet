...
class INET_API Contention : public cSimpleModule, public IContention
{
  ...
  public:
    ...
    // On 25/8/22, changed the below function to return backoffPeriod generated
    // virtual void startContention(int cw, simtime_t ifs, simtime_t eifs, simtime_t slotTime, ICallback *callback) override;
    virtual int startContention(int cw, simtime_t ifs, simtime_t eifs, simtime_t slotTime, ICallback *callback) override;
