...
class INET_API MacProtocolBase : public LayeredProtocolBase, public cListener
{
  ...
  public:
    // Added by Reuben on 4/9/2022 for packet drop statistics collection
    static std::string getPacketInfoCSV(Packet *pk, std::string reason);
  //   static std::filesystem::path getCSVFilePath();
};
